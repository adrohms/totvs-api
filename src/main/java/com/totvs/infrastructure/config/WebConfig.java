...
public class WebConfig implements ServletContextInitializer, WebServerFactoryCustomizer<WebServerFactory> {
    ...
    public WebConfig(Environment env, TotvsProperties totvsProperties) {
        this.env = env;
...
//        if (env.acceptsProfiles(Profiles.of(TotvsProfileConstants.SPRING_PROFILE_DEVELOPMENT))) {
...
//        }
    ...
    public CorsFilter corsFilter() {
        ...
        CorsConfiguration config = totvsProperties.getCors();
