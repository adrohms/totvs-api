package com.totvs.infrastructure.exception;

import com.totvs.application.account.exception.*;
import com.totvs.application.common.exception.EmailAlreadyUsedException;
import com.totvs.application.util.HeaderUtil;
import com.totvs.infrastructure.config.TotvsProfileConstants;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleBadRequestAlertException(BadRequestAlertException ex, NativeWebRequest request) {
        return create(
            ex,
            request,
            this.createFailureAlert(applicationName, true, ex.getEntityName(), ex.getErrorKey(), ex.getMessage())
        );
    }
    ...
    public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
        ...
        if (activeProfiles.contains(TotvsProfileConstants.SPRING_PROFILE_PRODUCTION)) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "com.", "io.", "de.", "com.totvs");
    }
